...
public class GreatWestCasualtyApplication {
	...
	public GreatWestCasualtyApplication() {	
	...
	//==================='
	public GreatWestCasualtyHomePage openAdactinApplication() {
		try {
			browser.get(url);
		...
		return new  GreatWestCasualtyHomePage(browser);
